 ...
 * so the other three actuals are empty. Mirrors `PreferencesContext` in `:foundation:preferences`
 * and `DatabaseContext`: the app already knows how to supply one platform-shaped handle per
 * library.
 */
