...
| Question | Section |
| --- | --- |
| When a boundary has earned its own module | 10. Reuse and extraction model |
...
In this repository: `docs/architecture/adr/` holds the local ADRs, `docs/architecture/exceptions.md`
the exception process, and `docs/architecture/helix-adoption-plan.md` the adoption phases and their
status.
