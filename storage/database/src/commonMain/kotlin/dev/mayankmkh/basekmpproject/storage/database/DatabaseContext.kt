 ...
 * -- so the other three actuals are empty. Mirrors `PrefContext` in `:foundation:preferences`
 * deliberately: the app already knows how to supply one platform-shaped handle per library.
 */
