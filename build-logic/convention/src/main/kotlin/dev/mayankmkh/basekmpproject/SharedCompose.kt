...
internal fun Project.configureKMPCompose() {
    ...
    pluginManager.withPlugin("com.android.kotlin.multiplatform.library") {
        dependencies {
            // The bundle carries `ui-tooling-preview`, the `@Preview` annotation itself; this is
            // the renderer that draws those previews in the IDE. A KMP module puts it on
...
private fun Project.configureComposeUiTest() {
    extensions.getByType<KotlinMultiplatformExtension>().sourceSets.configureEach {
        ...
        dependencies {
            ...
            @Suppress("DEPRECATION") implementation(ComposePlugin.DesktopDependencies.currentOs)
        }
    }
}
...
private fun Project.configureComposeCompiler() {
    extensions.configure<ComposeCompilerGradlePluginExtension> {
        ...
        fun Provider<*>.relativeToRootProject(dir: String) = map {
            outputRoot.dir(relativePath).dir(dir)
        }
